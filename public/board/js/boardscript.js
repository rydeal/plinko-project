...
function createScene() {
    ...
    var camera = new BABYLON.UniversalCamera("UC", new BABYLON.Vector3(0, 0, -25), scene);
    ...
    var plane = BABYLON.MeshBuilder.CreatePlane("plane", {width: 28.2, size:22, tileSize:1}, scene);
    ...
    var ground = BABYLON.MeshBuilder.CreateGround("ground", { height: 20, width: 50, subdivions: 4}, scene);

    // making the pressure plates
    var left100 = BABYLON.MeshBuilder.CreateGround("left100", { height: 20, width: 2.25, subdivions: 4}, scene);
    var right100 = BABYLON.MeshBuilder.CreateGround("right100", { height: 20, width: 2.25, subdivions: 4}, scene);
    var left500 = BABYLON.MeshBuilder.CreateGround("left500", { height: 20, width: 1.75, subdivions: 4}, scene);
    var right500 = BABYLON.MeshBuilder.CreateGround("right500", { height: 20, width: 1.75, subdivions: 4}, scene);
    var left1000 = BABYLON.MeshBuilder.CreateGround("left1000", { height: 20, width: 1.75, subdivions: 4}, scene);
    var right1000 = BABYLON.MeshBuilder.CreateGround("right1000", { height: 20, width: 1.75, subdivions: 4}, scene);
    var left0 = BABYLON.MeshBuilder.CreateGround("left0", { height: 20, width: 1.75, subdivions: 4}, scene);
    var right0 = BABYLON.MeshBuilder.CreateGround("right0", { height: 20, width: 1.75, subdivions: 4}, scene);
    var maximum = BABYLON.MeshBuilder.CreateGround("maximum", { height: 20, width: 1.75, subdivions: 4}, scene);
    ...
    var diamond11 = BABYLON.Mesh.CreateCylinder("diamond11", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond12 = BABYLON.Mesh.CreateCylinder("diamond12", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond13 = BABYLON.Mesh.CreateCylinder("diamond13", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond14 = BABYLON.Mesh.CreateCylinder("diamond14", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond15 = BABYLON.Mesh.CreateCylinder("diamond15", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);    
    ...
    var diamond21 = BABYLON.Mesh.CreateCylinder("diamond11", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond22 = BABYLON.Mesh.CreateCylinder("diamond12", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond23 = BABYLON.Mesh.CreateCylinder("diamond13", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond24 = BABYLON.Mesh.CreateCylinder("diamond14", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);  
    ...
    var diamond31 = BABYLON.Mesh.CreateCylinder("diamond11", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond32 = BABYLON.Mesh.CreateCylinder("diamond12", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond33 = BABYLON.Mesh.CreateCylinder("diamond13", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond34 = BABYLON.Mesh.CreateCylinder("diamond14", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond35 = BABYLON.Mesh.CreateCylinder("diamond15", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);    
    ...
    var diamond41 = BABYLON.Mesh.CreateCylinder("diamond41", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond42 = BABYLON.Mesh.CreateCylinder("diamond42", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond43 = BABYLON.Mesh.CreateCylinder("diamond43", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond44 = BABYLON.Mesh.CreateCylinder("diamond44", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);  
    ...
    var diamond51 = BABYLON.Mesh.CreateCylinder("diamond11", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond52 = BABYLON.Mesh.CreateCylinder("diamond12", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond53 = BABYLON.Mesh.CreateCylinder("diamond13", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond54 = BABYLON.Mesh.CreateCylinder("diamond14", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);
    var diamond55 = BABYLON.Mesh.CreateCylinder("diamond15", 1.5, 1.5, 1.5, 4, 1, scene, false, BABYLON.Mesh.DEFAULT);    
    ...
    scene.registerAfterRender(function() {
        ...
        if(ball.intersectsMesh(diamond51, false)) {
         ...
         if(ball.intersectsMesh(left100, false) || (ball.intersectsMesh(right100, false))) {
            console.log("100");
            itWorks();
         }
         if(ball.intersectsMesh(left500, false) || (ball.intersectsMesh(right500, false))) {
             console.log("500");
             itWorks();
         }
         if(ball.intersectsMesh(left1000, false) || (ball.intersectsMesh(right1000, false))) {
             console.log("1000");
             itWorks();
         }
         if(ball.intersectsMesh(left0, false) || (ball.intersectsMesh(right0, false))) {
             console.log("0");
             itWorks();
         }
